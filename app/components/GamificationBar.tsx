        ...
        <div className="hidden sm:flex items-center justify-between gap-4 md:gap-8">
          ...
          <div className="flex items-center gap-4 md:gap-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <div className={`text-xs md:text-sm ${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}`}>Credit Score</div>
                <div className={`text-base md:text-lg font-bold ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>820</div>
              </div>
            </div>
          </div>
        </div>
